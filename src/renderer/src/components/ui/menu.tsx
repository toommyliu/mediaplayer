...
export function MenuCheckboxItem({
  ...
  return (
    ...
    >
      {variant === "switch" ? (
        <>
          <span className="col-start-1 flex items-center gap-2 whitespace-nowrap">{children}</span>
        ...
        <>
          ...
          <span className="col-start-2 flex items-center gap-2 whitespace-nowrap">{children}</span>
        </>
      )}
    </MenuPrimitive.CheckboxItem>
  );
